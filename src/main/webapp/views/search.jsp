					...
					<div class="header__nav">
						<div class="container">
							<div class="header__nav-flex">
								...
								<ul class="menu-nav">
									<li class="active_menu"><a href="/product/search" title="Trang chủ"
										class="nav-link home"> <svg width="18" height="18"
									...
									<li><a title="Media" href="" class="nav-link">Search
									</a></li>
									...
									<li><a title="Xe" href="/admin/loginIndex" class="nav-link ">Quan ly </a></li>
		...
		<aside class="col-md-2"
			...
			<div class="panel panel-default" style="border-style: none;">
				...
				<div class="list-group">
						...
						style="background-color: #1a1717; color: aliceblue; border-style: none;" href="/product/search/category/${category.id}">${category.name}</a>
			...
			<div class="panel panel-default" style="border-style: none;">
				<div class="panel-heading"
					...
					<span class="glyphicon glyphicon-star-empty"></span> <strong>Best Seller</strong>
				</div>

				<div class="list-group">
					<a
						class="list-group-item"
						style="background-color: #1a1717; color: aliceblue; border-style: none;"	href="/product/search/sort-by-price"><i
								class="fas fa-sort-amount-up"></i> Cao đến thấp</a>
						<a class="list-group-item"
						style="background-color: #1a1717; color: aliceblue; border-style: none;"
							href="/product/search/sort-by-priceAsce"><i
								class="fas fa-sort-amount-down"></i> Thấp lên cao</a>
					...
					<div class="carousel-inner" style="width: 1490px;">
						<div class="carousel-item active">
							<img class="d-block w-100 img-fluid"
								src="/images/apple-iphone-6-glitter__1_.jpg"
								alt="1">
						</div>
